...
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>public/template/css/growl.css" />
...
<script type="text/javascript" src="<?php echo base_url(); ?>public/template/js/gmap3.min.js"></script>
<script type="text/javascript">
    base_url = '<?php echo base_url(); ?>'
    site_url = '<?php echo site_url(); ?>'
</script>
<script type="text/javascript" src="<?php echo base_url(); ?>public/template/js/main.js"></script>